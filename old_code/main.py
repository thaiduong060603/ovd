...
def main():
    ...
    parser.add_argument('--rule', help="Path to rule json")
    parser.add_argument('--rule-text',type=str,help="Generate rule from text using OpenAI")
    ...
    if args.rule_text:
        rule_path = Path(
            generate_rule_file(args.rule_text))
    else:
